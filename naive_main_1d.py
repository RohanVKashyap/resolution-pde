...
from utils.loss import RelativeL2Loss, get_lower_resolutions
...
def main(args: DictConfig):
    ...
    train_resolution = data_resolution // args.dataset['dataset_params']['reduced_resolution'] # Training Resolution (64)
    ...
    loss_history, val_loss_history = train(
                        ...
                        time=1, model_type=model_type, epochs=epochs, device=device)
    
    # Test model: We need to adapt this for POS evaluation
